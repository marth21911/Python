...
Brian.deposit (5).deposit (300).deposit (25000).withdraw (500).yield_interest()
Sariah.deposit (200).deposit(400).withdraw(50).withdraw(75).withdraw(50).withdraw(100).yield_interest().display_account_info()
